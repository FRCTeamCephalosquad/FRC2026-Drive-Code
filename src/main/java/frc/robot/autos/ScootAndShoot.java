...
public class ScootAndShoot extends SequentialCommandGroup {
    ...
    public ScootAndShoot(DriveSubsystem driveSubsystem, FuelSubsystem ballSubsystem, ClimberSubsystem climb, Supplier<Pose2d> poseSupplier) {
        ...
        Command aim = new AutoAimCommand(driveSubsystem, poseSupplier)
